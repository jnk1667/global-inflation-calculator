                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-8 right-0 w-52 bg-white/95 backdrop-blur-sm rounded-lg shadow-lg border border-gray-200 dark:border-gray-600 dark:bg-gray-800/95 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 ease-in-out">
                    <div className="py-2">
                      ...
                      <Link href="/lifestyle-inflation-calculator" className="block px-4 py-2 text-sm text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">Lifestyle Inflation Calculator</Link>
                      ...
                      <Link href="/sneakflation-calculator" className="block px-4 py-2 text-sm text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">Sneakflation Calculator</Link>
                    </div>
                  </div>
                </div>

                {/* Blue Circle Dropdown — Info & Legal */}
                <div className="relative group">
                  <div className="w-6 h-6 bg-blue-500 dark:bg-blue-600 rounded-full cursor-pointer hover:bg-blue-600 dark:hover:bg-blue-500 transition-colors flex-shrink-0"></div>
                  <div className="absolute top-8 right-0 w-52 bg-white/95 backdrop-blur-sm rounded-lg shadow-lg border border-gray-200 dark:border-gray-600 dark:bg-gray-800/95 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 ease-in-out">
                    <div className="py-2">
                      ...
                      <Link href="/llms.txt" className="block px-4 py-2 text-sm text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">LLMs.txt</Link>
                    </div>
                  </div>
                </div>
              </div>
